...
You can start editing the page by modifying `app/page.js`. The page auto-updates as you edit the file(Don't hesitate to make a PR or to open an issue if you have an idea you want to implement).
